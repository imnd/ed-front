<template>
  <div>
    <div class="courses-filters">
      ...
      <div class="courses-filters__table-header" v-if="!isLoading && courses.length > 0">
        <div

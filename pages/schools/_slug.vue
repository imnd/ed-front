  ...
  <div class="edv-object middle-container">
    <div class="content-edv-object">
      ...
      <div class="buttons-object">
        <a :href="`http://edvisor/goto?sg=3&obj=${school.id}`" target="_blank" class="btn-feo-arrow btn-feo">На сайт
          школы</a>
      </div>
...
export default {
  /*async fetch() {
    ...
    try {
      ...
      const { data: school } = await $http.get(`/schools/${slug}`);
      this.school = school;
      commit('setState', {
        key:  'school',
        value: school
  ...
  /*async asyncData({route, params}) {
    try {
      ...
      const { data: school } = await $http.get(`/schools/${params.slug}`);
      return { school };
    } catch (error) {
      console.error(error);
      return false;

<template>
  <div class="reviews-slider middle-container">
    ...
    <div class="reviews-slider__control reviews-slider__control_right">
      <button class="reviews-slider__control-button reviews-slider__control-button_right" @click="handleControl('right')">
        <svg>
...
// почему то не импортируется автоматически
...
.reviews-slider {
  ...
  &__list {
    ...
    display: grid;
    grid-template-columns: repeat(6, calc(100%));

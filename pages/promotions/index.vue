<template>
  <div class="middle-container">
    <div class="edv-shares" v-if="promotions.length > 0">
      ...
      >
        <div class="img">
          <img v-if="promotion.logo" :src="promotion.logo" class="img img-fluid">
        </div>
        <div class="reviews">
          <div class="title">{{ promotion.school_name }}</div>
        ...
        <div class="date">Срок проведения: c {{ formatDate(promotion.started_at) }} до
          {{ formatDate(promotion.finished_at) }}
        </div>
        <div class="title-shares">{{ promotion.promo_title }}</div>
        <div class="text">
          {{ promotion.promo_description }}
        </div>
        <a :href="promotion.promo_url" target="_blank" class="btn-feo btn-feo-arrow">Акция на сайте школы</a>
      </div>
    </div>
...
.content ol:not([class]), main ol:not([class]) {
  list-style: decimal;
  padding-left: 30px;
  margin-bottom: 15px;
}

.content ul:not([class]) li:not([class]), main ul:not([class]) li:not([class]) {
  margin-bottom: 5px;
}
...
.close-mob:before, .close-mob:after, .cls_flt:before, .cls_flt:after, .close:before, .close:after {
  position: absolute;
  left: 18px;
  content: ' ';
  height: 30px;
...
.close-mob::before, .cls_flt::before, .close::before {
  -webkit-transform: rotate(45deg);
  -ms-transform: rotate(45deg);
  transform: rotate(45deg);
}

.close-mob:after, .cls_flt:after, .close:after {
  -webkit-transform: rotate(-45deg);
  -ms-transform: rotate(-45deg);
  transform: rotate(-45deg);
}
...
.checkbox input:checked + .checkbox__text:after {
  content: '';
  position: absolute;
  background: url("assets/images/check.svg") no-repeat center center, #fff;
  width: 20px;
  height: 20px;
  top: 0;
  left: 0;
...
.checkbox.check-no-all input:checked + .checkbox__text:after {
  content: '';
  position: absolute;
  background: url("assets/images/no-all.svg") no-repeat center center, #fff;
  width: 20px;
  height: 20px;
  top: 0;
  left: 0;
...
.select2-container--default .sorting_result .select2-results > .select2-results__options {
  min-height: 295px;
}
...
.select2-container--default .select2-results__option.toggled li:hover, .select2-container--default .select2-results__option.toggled li[aria-selected="true"] {
  background: #F2F2F2;
}
...
.sorting_result .select2-results li:nth-child(4), .sorting_result .select2-results li:nth-child(3) {
  position: relative;
}
...
.sorting_result .select2-results li:nth-child(4):after, .sorting_result .select2-results li:nth-child(3):after {
  content: '';
  background: url("assets/images/arr_top.svg") no-repeat center center;
  position: absolute;
  top: 50%;
  height: 16px;
  width: 11px;
...
.arr_bottom:after, .arr_top:after {
  content: '';
  background: url("assets/images/arr_down.svg") no-repeat center center;
  position: absolute;
  top: 50%;
  height: 16px;
  width: 11px;
...
select {
  ...
  background: url("assets/images/select.svg") no-repeat -webkit-calc(100% - 22px) center, #fff;
  background: url("assets/images/select.svg") no-repeat calc(100% - 22px) center, #fff;
  -moz-appearance: none;
  -o-text-overflow: '';
  text-overflow: '';
  -ms-appearance: none;
...
@media (min-width: 767px) {
  ...
  .compilation-top_h1.top_h1_text .breadcrumbs__link, .compilation-top_h1.top_h1_text .breadcrumbs__current, .compilation-top_h1.top_h1_text .breadcrumbs__separator {
    color: #ffffff;
  }
}
...
.sections .rating, .rev_items .comment .rating, .rating {
  display: -webkit-box;
  display: -webkit-flex;
  display: -ms-flexbox;
  display: flex;
...
.modal-response-text-error, .message.error-message, .message.success-message {
  color: #856404;
...
.sections .rating .rating_ball, .messia-comment-form .rating .rating_ball, .rev_items .comment .rating .rating_ball {
  margin-bottom: 1px;
  color: #333333;
  margin-left: 2px;
  order: 3;
...
.sections .rating .ratingCount, .messia-comment-form .rating .ratingCount, .rev_items .comment .rating .ratingCount, .ratingCount {
  display: -webkit-box;
  display: -webkit-flex;
  display: -ms-flexbox;
  display: flex;
...
.sections .rating .ratingCount a, .messia-comment-form .rating .ratingCount a, .rev_items .comment .rating .ratingCount a {
  font-weight: normal;
  color: #208dd7;
  text-decoration: none;
}
...
@media (max-width: 991px) {
  .sections .checkbox__text:before {
    background: url("assets/images/sravnit.svg") no-repeat;
...
.sections .stars, .popular .stars, .rev_items .comment .stars, .messia-comment-form .stars, .stars {
  width: 81px;
  flex-basis: 81px;
  margin-left: auto;
}
...
.sections .stars, .popular .stars, .messia-comment-form .stars, .rev_items .comment .stars, .stars {
  position: relative;
  margin-right: 10px;
  cursor: pointer;
  order: 2;
...
.sections .stars small, .popular .stars small, .rev_items .comment .stars small, .messia-comment-form .stars small, .stars small {
  background: url("assets/images/ratingStars.png") no-repeat left top;
...
.sections .stars small, .popular .stars small, .messia-comment-form .stars small, .rev_items .comment .stars small, .stars small {
  z-index: 4;
  position: absolute;
  width: 83px;
  top: -1px;
...
.sections .stars span.bg, .popular .stars span.bg, .messia-comment-form .stars span.bg, .rev_items .comment .stars span.bg, .stars span.bg {
  position: absolute;
  width: 83px;
  top: 0;
  left: 0;
...
.sections .stars span.bg_active, .popular .stars span.bg_active, .messia-comment-form .stars span.bg_active, .rev_items .comment .stars span.bg_active, .stars span.bg_active {
  position: absolute;
  width: 100%;
  top: 0;
  left: 0;
...
.sections .stars i, .messia-comment-form .stars i, .rev_items .comment .stars i, .stars i {
  margin-right: 5px;
}
...
.sections a.picture, .sections picture.img-placeholder {
  padding: 4px;
  display: -webkit-box;
  display: -webkit-flex;
  display: -ms-flexbox;
...
@media (max-width: 767px) {
  ...
  .sections .rating .ratingCount, .messia-comment-form .rating .ratingCount, .rev_items .comment .rating .ratingCount {
    font-size: 12px;
    margin-right: 0;
    width: auto;
  }
...
.links .container .links_item li:nth-child(1), .links .container .links_item li:nth-child(2), .links .container .links_item li:nth-child(3), .links .container .links_item li:nth-child(4), .links .container .links_item li:nth-child(5) {
...
.login_reg form input[type="text"], .login_reg form input[type="password"] {
  display: block;
  background: #EFF7F9;
  -webkit-border-radius: 5px;
  border-radius: 5px;
...
.links_object a:nth-child(1), .links_object a:nth-child(2), .links_object a:nth-child(3), .links_object a:nth-child(4), .links_object a:nth-child(5), .links_object a:nth-child(6), .links_object a:nth-child(7), .links_object a:nth-child(8), .links_object a:nth-child(9), .links_object a:nth-child(10) {
  display: block !important;
}
...
.tab-pane > #respond, .tab-content > #respond {
  margin-left: auto;
  margin-right: auto;
  display: none;
}
...
.yes {
  background: url("assets/images/yes.svg") no-repeat center center;
  width: 24px;
  height: 19px;
  margin-left: auto;
  margin-right: auto;
...
.add_rev .textarea span, .comment-form-author label {
  display: block;
  margin-bottom: 10px;
}
...
.add_rev .textarea textarea#comment::-webkit-input-placeholder, #first_name::-webkit-input-placeholder {
  color: #FF6557;
}

.add_rev .textarea textarea#comment:-ms-input-placeholder, #first_name:-ms-input-placeholder {
  color: #FF6557;
}

.add_rev .textarea textarea#comment::-moz-placeholder, #first_name::-moz-placeholder {
  color: #FF6557;
  opacity: 1;
}
...
.media-grid h2 .line, .hide-siblings .line {
  margin-left: 15px;
  margin-right: 15px;
  -webkit-box-flex: 1;
  -webkit-flex-grow: 1;
...
.media-grid h2 small, .hide-siblings small {
  font-weight: normal;
  font-size: 12px;
  position: relative;
  display: inline-block;
...
.media-grid h2 small:after, .hide-siblings small:after {
  content: '';
  position: absolute;
  width: 9px;
  height: 8px;
...
.media-grid h2 small:before, .hide-siblings small:before {
  content: 'свернуть';
}

.media-grid h2 small.active:after, .hide-siblings small.active:after {
  -webkit-transform: rotate(0deg);
  -ms-transform: rotate(0deg);
  transform: rotate(0deg);
}

.media-grid h2 small.active:before, .hide-siblings small.active:before {
  content: 'развернуть';
}

.media-grid .eshe, .media-grid .video .eshe {
  display: -webkit-box;
  display: -webkit-flex;
  display: -ms-flexbox;
  display: flex;
...
.select_post_multi div, .sidebar-popular-items {
  background: #fff;
  padding: 20px;
}
...
.popular .flex .item:nth-child(1), .popular .flex .item:nth-child(2), .popular .flex .item:nth-child(3), .popular .flex .item:nth-child(4) {
  display: flex;
  flex-direction: column;
}
...
.popular .flex .rating .ratingCount a, .ratingCount a {
  color: #208DD7;
  font-weight: normal;
  font-size: 14px;
}
...
.popular .flex .rating .ratingCount svg, .ratingCount svg {
  width: 15px;
  margin-right: 10px;
}
...
.all_category, .stati, .review_home {
  width: 100%;
}
...
#popup_modal .modal-dialog .modal-body, #popup_modal .modal-dialog .modal-content {
  -webkit-border-radius: 0;
  -moz-border-radius: 0;
  border-radius: 0;
  background: #ffffff;
...
.count_rewiew .zv {
  background: url("assets/images/zv.svg") no-repeat center center;
  width: 15px;
  height: 14px;
  display: block;
  margin-right: 13px;
...
.all_ocen {
  ...
  position: relative;
  padding-top: 36px;
  background: url("assets/images/bg_sred.svg") no-repeat center center;
}
...
.rev_items .comment .all_ocen .stars small {
  ...
  background-image: url("assets/images/ratingStars.png");
}
...
.page_comment .sections h1:after {
  content: 'Отзывы о школе и ее курсах';
  position: absolute;
  top: 0;
  left: 0;
  font-size: 14px;
...
/*Форма входа*/
.oauth-register-form, .oauth-reset-form {
  display: none;
}
...
.oauth-social-buttons a:hover, .oauth-social-buttons a.active {
  background: #208DD7;
}

.oauth-social-buttons a.active path, .oauth-social-buttons a:hover path {
  fill: #fff;
}
...
.avatar_sidebar_lk .replace_menu_click.active::after, .avatar_sidebar_lk .replace_menu_click:hover:after {
  opacity: 1;
}

.avatar_sidebar_lk .replace_menu_click:hover svg, .avatar_sidebar_lk .replace_menu_click.active svg {
  opacity: 1;
}
...
.sidebar_menu li.active a:after, .sidebar_menu a:hover:after {
  opacity: 1;
}
...
.comparison .item_comparison .item {
  width: 33%;
  background: url("assets/images/comparison.svg") no-repeat center right;
...
.mobile-buttons-filter-compare, .apply-mobile-filter {
  display: none;
}
...
@media (min-width: 1199px) {
  .compar .comparsion_items-outer.no-fixed-adds .comparsion_item:nth-child(1), .compar .comparsion_items-outer.no-fixed-adds .comparsion_item:nth-child(2), .compar .comparsion_items-outer.no-fixed-adds .comparsion_item:nth-child(3), .compar .comparsion_items-outer.no-fixed-adds .comparsion_item:nth-child(4) {
    display: block;
  }

  .compar .comparsion_items-outer.fixed-adds .comparsion_item:nth-child(1), .compar .comparsion_items-outer.fixed-adds .comparsion_item:nth-child(2), .compar .comparsion_items-outer.fixed-adds .comparsion_item:nth-child(3) {
    display: block;
  }

  .review-service .comparsion_items-outer.no-fixed-adds .comparsion_item:nth-child(1), .review-service .comparsion_items-outer.no-fixed-adds .comparsion_item:nth-child(2), .review-service .comparsion_items-outer.no-fixed-adds .comparsion_item:nth-child(3) {
    display: block;
  }
}

@media (min-width: 990px) {
  .comparsion_items-outer.no-fixed-adds .comparsion_item:nth-child(1), .comparsion_items-outer.no-fixed-adds .comparsion_item:nth-child(2), .comparsion_items-outer.no-fixed-adds .comparsion_item:nth-child(3) {
    display: block;
  }

  .comparsion_items-outer.fixed-adds .comparsion_item:nth-child(1), .comparsion_items-outer.fixed-adds .comparsion_item:nth-child(2) {
    display: block;
  }
}

@media (min-width: 766px) {
  .comparsion_items-outer.no-fixed-adds .comparsion_item:nth-child(1), .comparsion_items-outer.no-fixed-adds .comparsion_item:nth-child(2) {
    display: block;
  }
...
.comparsion-fixed .comparsion_item_header, .comparsion-fixed .comparsion_list {
  background: #F5FCFF;
}
...
.course-page .sticky .comparsion_lock, .course-page .sticky .comparsion_close {
  bottom: 7px;
}
...
.comparsion_item_header.sticky:after, .comparsion_sidebar_inner.sticky:after {
  content: "";
  position: absolute;
  width: 100%;
  bottom: 5px;
...
.comparsion_item_header.sticky:before, .comparsion_sidebar_inner.sticky:before {
  content: "";
  position: absolute;
  width: 100%;
  bottom: 5px;
...
.comparsion_lock:hover path, .comparsion_lock.active path {
  fill: #208DD7;
}
...
.compar .comparsion_item:hover .comparsion_close, .compar .comparsion_item:hover .comparsion_lock {
  visibility: visible;
  opacity: 1;
}
...
.comparsion_item *, .comparsion_sidebar * {
  transition: all 0.4s;
}
...
.comparsion_flex_left .comparsion_item, .comparsion_flex_right .comparsion_item {
  display: none;
  width: 100% !important;
}
...
.comparsion_flex_left, .comparsion_flex_right {
  width: 50%;
}
...
@media (max-width: 767px) {
  ...
  .comparsion_list li:nth-child(4), .comparsion_list li:nth-child(5), .comparsion_list li:nth-child(6) {
    display: flex;
  }
  ...
  .comparsion_sidebar { /* display: none; */
  }
  ...
  .compilation-item-col-2, .compilation-item-col-1, .compilation-item-col-3 {
    width: 100%;
  }
...
.compare-icon {
  background: url("assets/images/compare-icon.svg");
  margin-bottom: 10px;
  margin-top: 10px;
  width: 24px;
  height: 24px;
...
.analog-page .sections .footer_section:after, .analog-page .sections .footer_section:before {
  content: "";
  position: absolute;
  height: 1px;
  left: -25px;
...
@media (max-width: 500px) {
  ...
  .analog-page .sections .footer_section::after, .analog-page .sections section::before {
    content: "";
    position: absolute;
    height: 1px;
    left: -15px;
...
.image-stock + .description-stock, .video-stock + .description-stock {
  padding-right: 22px;
  width: calc(100% - 310px);
}
...
@media (max-width: 767px) {
  ...
  .image-stock img, .video-stock iframe {
    width: 100%;
  }
  ...
  .media-grid h3 small::before, .hide-siblings small::before {
...
/* width *//* Track *//* Handle */
.table_over::-webkit-scrollbar-thumb, .tabs_object .navs_over::-webkit-scrollbar-thumb, .double-scroll::-webkit-scrollbar-thumb {
  background: #208DD7;
  -webkit-border-radius: 10px;
  -moz-border-radius: 10px;
  border-radius: 10px;
...
.comparison-bar-buttons a, .comparison-bar-buttons button {
  max-height: 45px;
  line-height: 1;
}
...
.comparison-bar__item:nth-child(1), .comparison-bar__item:nth-child(2), .comparison-bar__item:nth-child(3), .comparison-bar__item:nth-child(4), .comparison-bar__item:nth-child(5) {
  display: block;
}
...
.disadvantages-ul, .advantage-ul, .keep-ul, .function-ul {
  margin-bottom: 30px;
}

.disadvantages-ul li, .advantage-ul li, .keep-ul li, .function-ul li {
...
.disadvantages-ul ul, .advantage-ul ul, .keep-ul ul, .basic-information ul, .function-ul ul {
  padding-left: 0 !important;
  list-style: none !important;
}
...
.disadvantages-ul h3, .object-characteristics h3, .advantage-ul h3, .keep-ul h3, .basic-information h3, .function-ul h3 {
  margin-bottom: 15px;
  font-size: 16px;
  font-weight: 900;
}
...
.table-reklama-link:after {
  ...
  width: 100%;
  height: 100%;
  background: url("assets/images/table-reklama-link.svg") no-repeat center center;
  top: 0;
  left: 0;
  transition: all 0.3s;
}
...
.table-reklama-link:before {
  ...
  width: 100%;
  height: 100%;
  background: url("assets/images/table-reklama-link-hover.svg") no-repeat center center;
  top: 0;
  left: 0;
  transition: all 0.3s;
  opacity: 0;
...
.popular-row:after {
  content: '';
  position: absolute;
  background: url("assets/images/ogn.svg") no-repeat left center;
  width: 12px;
  height: 14px;
  left: 15px;
  top: 50%;
...
.table-reklama-items .no {
  background: url("assets/images/no.svg") no-repeat center center;
}

.table-reklama-items .no::after, .table-reklama-items .no::before {
  content: none;
}
...
.table-reklama-items li.yes {
  background-image: url('assets/images/yes-rek.svg');
}
...
.mark.nomark {
  background-image: url('assets/images/nopoint.svg');
}
...
.online-listing-characteristic .points, .online-listing-characteristic .rating_ball, .online-listing-characteristic .stars {
  margin-bottom: 10px !important;
  margin-top: 0;
  margin-left: 0;
}
...
.btn-blue:hover svg, .btn-blue:hover path {
  fill: #3C78E6;
  stroke: #3C78E6;
}
...
.question .icon {
  width: 24px;
  height: 24px;
  background: url('assets/images/question.svg') center center no-repeat;
  cursor: pointer;
}
...
@media (max-width: 767px) {
  ...
  .online-listing-footer__more::before {
    ...
    position: absolute;
    right: 0;
    background: url('assets/images/arrow-down.svg') right center no-repeat;
    width: 12px;
    height: 7px;
    top: 50%;
    margin-top: -3px;
...
@media (max-width: 550px) {
  ...
  .groups-crosslinks-wrapper .group-holder .group-title a:after {
    content: '';
    position: absolute;
    background: url("assets/images/grout-arrow.svg") no-repeat center center;
    width: 8px;
    height: 8px;
    right: 0;
    top: 50%;
...
.compare_all {
  ...
  -moz-border-radius: 5px;
  border-radius: 5px;
  background: url("assets/images/compareall.svg") no-repeat 21px center, #ffffff;
  margin-left: 21px;
}
...
.item-advantages.item-advantages-format .title {
  background-image: url('assets/images/monitor.svg');
...
.rev-object .item:nth-child(1), .rev-object .item:nth-child(2), .rev-object .item:nth-child(3), .rev-object .item:nth-child(4), .rev-object .item:nth-child(5) {
  display: block !important;
}
...
.front-category__item .sub-title {
  font-size: 16px;
  margin-bottom: 12px;
  line-height: 150%;
  color: #ffffff;
...
.front-category__item-color-1 {
  background: #9B5DE5;
}

.front-category__item-color-2 {
  background: #F15BB5;
}

.front-category__item-color-3 {
  background: #FEE440;
}

.front-category__item-color-3 .title, .front-category__item-color-3 .sub-title {
  color: #333333;
}

.front-category__item-color-4 .title, .front-category__item-color-4 .sub-title {
  color: #333333;
}

.front-category__item-color-4 {
  background: #15E2C6;
}

.front-category__item-color-5 {
  background: #00BBF9;
}

.front-category__item-color-6 {
  background: #FE4C40;
}

.front-category__item-color-7 {
  background: #FFA800;
}
...
.edvlisting-sidebar aside {
  margin-bottom: 32px;
}

.edvlisting-sidebar .checkbox {
  display: block;
  margin-bottom: 20px;
}
...
.checkbox-toplevel-toggle {
  width: 20px;
  height: 20px;
  display: block;
  background: url('assets/images/toggle.svg') center center no-repeat;
  border: none;
}

.toggled .checkbox-toplevel-toggle {
  transform: rotate(180deg);
}

.checkbox-toplevel-row {
  display: flex;
  justify-content: space-between;
  align-items: center;
}
...
.checkbox-group.toggled .checkbox-items {
  display: block;
}
...
.see-all-checkbox {
  display: inline-block;
  background: url('assets/images/see.svg') right center no-repeat;
  color: #9B5DE5;
  border: none;
  padding-left: 0;
  padding-right: 27px;
...
.edvlisting-sidebar .checkbox-toplevel.checkbox {
  margin-bottom: 0;
}
...
.edvlisting-item .sale {
  position: absolute;
  background: url('assets/images/sale.svg') center center no-repeat;
  width: 60px;
  height: 60px;
  display: flex;
  align-items: center;
...
.flex-description .item {
}

.flex-description .characteristics {
  max-width: 621px;
...
.flex-description .characteristics .title {
  color: #B8B8B8;
  margin-bottom: 4px;
  font-weight: 500;
  font-size: 14px;
...
.flex-description .characteristics .item {
  margin-right: 12px;
  max-width: 199px;
  width: calc(33% - 12px);
}

.flex-description .characteristics .item:last-child {
  margin-right: 0;
}

.flex-description .characteristics .text {
  color: #333333;
  font-size: 16px;
  min-height: 21px;
  display: flex;
...
.flex-description .characteristics .promo .text {
  color: #9B5DE5;
  font-weight: 800;
  font-size: 16px;
  line-height: 130%;
...
.school .reviews .title {
  margin-bottom: 0;
  margin-right: 12px;
}

.school .flex-description {
  display: flex;
  align-items: center;
  margin-top: 20px;
}

.school .flex-description .text-desc {
...
.school .edvlisting-item .buttons {
  margin-top: 0;
}
...
.edvlisting-item .price {
  display: flex;
  align-items: flex-start;
  margin-top: 32px;
}

.edvlisting-item .price .item {
  margin-right: 16px;
  padding-right: 24px;
  position: relative;
}
...
.edvlisting-item .price .question {
  background: url('assets/images/question.svg') center center no-repeat;
  width: 16px;
  height: 16px;
  bottom: 5px;
...
.btn-feo.btn-feo-arrow:after {
  content: "";
  background: url('assets/images/btn-feo.svg') center center no-repeat;
  display: block;
  width: 16px;
  height: 16px;
  margin-left: 8px;
...
.btn-stat {
  ...
  border-radius: 50%;
  display: block;
  background: url('assets/images/stat.svg') center center no-repeat;
}

.btn-stat.compare-adds {
  background: url('assets/images/compare-empty.svg') center center no-repeat, #9B5DE5;
}
...
.title-sidebar-phone .close-filter {
  position: absolute;
  top: 20px;
  bottom: 20px;
  right: 32px;
...
.front-page .slick-arrow.slick-prev {
  left: -68px;
}

.front-page .slick-arrow.slick-next {
  right: -68px;
}
...
.stock .slider-tab .item .top .img {
  max-width: 100px;
}

.stock .slider-tab .item .top .sale {
  background: #FEE440;
  border-radius: 5px;
  padding: 6px 10px;
  font-size: 16px;
...
.stock .slider-tab .item .old {
  margin-bottom: 2px;
  font-size: 14px;
  font-weight: 500;
}

.stock .slider-tab .item .new {
  margin-bottom: 2px;
  font-size: 24px;
  font-weight: 800;
}
...
.rewiew .item .name .title {
  font-size: 16px;
  font-weight: 800;
  margin-left: 17px;
}

.rewiew .item .name .title .date {
  margin-top: 4px;
  color: #B8B8B8;
  font-size: 14px;
  font-weight: 500;
...
.rewiew .item .hidden-text-review {
  line-height: 140%;
  font-size: 14px;
  font-weight: 500;
  display: none;
...
.more-text-review.active:before {
  content: 'Скрыть';
  color: #9B5DE5;
  font-size: 14px;
  font-weight: 500;
...
.more-text-review:after {
  content: "";
  position: absolute;
  background: url('assets/images/see.svg') center center no-repeat;
  right: 0;
  top: 0;
  height: 100%;
  width: 20px;
...
.edv-stars i.star-gray {
  background: url('assets/images/star-gray.svg') center center no-repeat;
}
...
.edvlisting.listing-page h2 {
  margin-bottom: 16px;
}

.edvlisting.listing-page .toptext {
  margin-bottom: 40px;
  font-weight: 500;
  max-width: 856px;
  font-size: 18px;
...
.pagination-showsitem .showsitem {
  max-width: 200px;
}
...
.comparepopup .container .count-compare {
  color: #757575;
  font-size: 14px;
  font-weight: 500;
  line-height: 140%;
...
.comparepopup .right .btn-outline {
  display: flex;
  align-items: center;
  justify-content: center;
  font-size: 14px;
...
.comparepopup .right .btn-outline svg {
  margin-left: 8px;
}

.comparepopup .right .btn-outline:hover path {
  fill: #fff;
}
...
.btn-outline-mini svg {
  margin-left: 8px;
  fill: #9B5DE5;
}

.btn-outline-mini path {
  fill: #9B5DE5;
}

.btn-outline-mini:hover path {
  fill: #fff;
}
...
.edv-object .header-rating .left {
  position: relative;
  margin-right: 40px;
}

.edv-object .header-rating .right {
  display: flex;
  flex-direction: column;
  justify-content: space-between;
  padding-top: 3px;
...
.edv-object .header-rating .right span {
  color: #757575;
  font-size: 14px;
  font-weight: 500;
  margin-left: 16px;
...
.body-rating .title-sorting .title {
  font-size: 28px;
  font-weight: 800;
}
...
.stars-feo i {
  background: url('assets/images/rating-full.svg') center center no-repeat;
  -webkit-background-size: contain;
  background-size: contain;
  width: 16px;
  height: 16px;
...
.stars-feo i.active {
  background: url('assets/images/rating-full-feo.svg') center center no-repeat;
  -webkit-background-size: contain;
  background-size: contain;
  width: 16px;
  height: 16px;
...
.edv-object .header-rating .left span {
  font-size: 52px;
  font-weight: bold;
  position: absolute;
  top: 0;
...
.body-rating .items .left {
  max-width: 200px;
  width: 100%;
}

.body-rating .items .left .avatar img {
  width: 56px;
  height: 56px;
  -webkit-border-radius: 50%;
  -moz-border-radius: 50%;
...
.body-rating .items .left .avatar {
  margin-bottom: 8px;
}

.body-rating .items .left .name {
  font-size: 16px;
  font-weight: 800;
}

.body-rating .items .left .date {
  font-size: 14px;
  font-weight: 500;
  color: #B8B8B8;
  margin-bottom: 8px;
...
.body-rating .items .right .plus {
  padding-left: 36px;
  background: url('assets/images/plus-comment.svg') left top no-repeat;
  margin-bottom: 16px;
}

.body-rating .items .right .minus {
  padding-left: 36px;
  background: url('assets/images/minus-comment.svg') left top no-repeat;
  margin-bottom: 16px;
}

.body-rating .items .right .comment {
  padding-left: 36px;
  background: url('assets/images/comment.svg') left top no-repeat;
}

.body-rating .items .right .likes {
  display: flex;
  justify-content: flex-end;
  align-items: center;
  margin-top: 21px;
...
.body-rating .items .right button {
  min-height: 20px;
  display: flex;
  padding-left: 24px;
  align-items: center;
...
.body-rating .items .right .like {
  background: url('assets/images/like.svg') left center no-repeat;
  color: #9B5DE5;
  margin-right: 12px;
}

.body-rating .items .right .dislike {
  background: url('assets/images/dis.svg') left center no-repeat;
  color: #B8B8B8;
}

.select-sorting-container .select2-container {
  width: 100% !important;
}
...
@media (max-width: 1200px) {
  ...
  .title-sidebar:after {
    content: "";
    position: absolute;
    background: url('assets/images/arr-title.svg') right center no-repeat;
    width: 20px;
    height: 100%;
    right: 16px;
    transition: all 0.3s;
...
@media (max-width: 767px) {
  ...
  .edvlisting-sidebar aside.show-filter-phone-aside {
    padding-left: 15px;
    padding-right: 15px;
  }
...
@media (max-width: 700px) {
  ...
  .edvlisting-item .buttons .btn-feo-arrow {
    margin-right: 8px;
  }
...
.show-characteristics.active:before {
  content: 'Скрыть подробности';
}

.show-characteristics.active:after {
  transform: rotate(180deg);
}

.show-characteristics:after {
  content: '';
  background: url('assets/images/more-char.svg') center center no-repeat;
  width: 20px;
  position: absolute;
  right: 0;
  top: 0;
